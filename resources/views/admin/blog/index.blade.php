            ...
            <div class="col-md-12">
                <div class="card card-plain">
                    ...
                    <div class="card-header card-header-primary">
                        <div class="row">
                            <div class="col-md-8">
                                <h4 class="card-title mt-0">Blog List

                                    <a class="btn btn-default btn-sm create-new" href="{{ URL::to('blog/create') }}"> Add
                                        New
                    ...
                    <!-- Begin Filter-->
                    {!! Form::open(['group' => 'form', 'url' => 'blog/filter', 'class' => 'form-horizontal']) !!}
                                                ...
                                                <td class="td-actions text-center vcenter">
                                                    <div class="width-inherit">
                                                        <a class="btn btn-xs btn-primary tooltips" title="Edit"
                                                            href="{{ URL::to('blog/' . $target->id . '/edit') }}">
                                                            <i class="fa fa-edit"></i>
                                                        </a>

                                                        {{ Form::open(['url' => 'blog/' . $target->id, 'class' => 'delete-form-inline', 'onsubmit' => 'return confirm("Delete, are you sure ?")']) }}
